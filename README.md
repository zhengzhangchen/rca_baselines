...
LEMMA-RCA covers two domains and we provide both the raw data and preprocessed data. The detailed data statistics can be found in [Lemma-RCA Webpage](https://lemma-rca.github.io/docs/data.html).  
...
#### Step 1: Download the Case 20211203 of the preprocessed data
